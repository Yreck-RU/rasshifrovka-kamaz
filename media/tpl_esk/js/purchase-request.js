...
class PurchaseRequestElement extends HTMLElement
{
	#_config = config.get('purchase-request');
	...
	constructor()
	{
		...
		this.#_send_btn.setAttribute('type', 'button');
	...
	#_sendForm()
	{
		...
		recaptcha.execute((token) => {
			...
			data.append('task', 'xhr.purchase_request');
...
document.addEventListener('DOMContentLoaded', _ => {
	customElements.define('purchase-request', PurchaseRequestElement);
});