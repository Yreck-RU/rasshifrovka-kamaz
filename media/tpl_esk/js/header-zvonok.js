...
class HeaderZvonokElement extends HTMLElement
{
	#_config = config.get('header-zvonok');
	...
	#_sendForm()
	{
		...
		recaptcha.execute((token) => {
			...
			data.append('task', 'xhr.header_zvonok');
...
document.addEventListener('DOMContentLoaded', _ => {
	customElements.define('header-zvonok', HeaderZvonokElement);
});