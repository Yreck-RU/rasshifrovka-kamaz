...
class ProductCompareElement extends HTMLElement
{
	#_mlink = document.querySelector(
		'a.main-link-inner.compare'
	);

	#_slink = document.querySelector(
		'a.sidebar-link-inner.compare'
	);
	...
	#_send(mouse)
	{
		recaptcha.execute((token) => {
			...
			data.append('task', 'xhr.product_compare');
...
document.addEventListener('DOMContentLoaded', _ => {
	customElements.define('product-compare', ProductCompareElement);
});