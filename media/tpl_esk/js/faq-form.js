...
class FaqFormElement extends HTMLElement
{
	#_config = config.get('faq-form');
	...
	connectedCallback()
	{
		...
		this.#_request.addEventListener('success', _ => {
...
document.addEventListener('DOMContentLoaded', _ => {
	customElements.define('faq-form', FaqFormElement);
});