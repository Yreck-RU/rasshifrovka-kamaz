const BASE_MODAL_DIALOG = 'modal-dialog';
const BASE_MODAL_CONTENT = 'modal-content';
const BASE_MODAL_HEADER = 'modal-header';
const BASE_MODAL_TITLE = 'modal-title';
const BASE_MODAL_CLOSE = 'modal-close';
const BASE_MODAL_BODY = 'modal-body';
const BASE_MODAL_BODY_OPEN = 'modal-open';

class DialogModal extends EventTarget
{
	#_element;
	#_content;
	#_header;
